        ...
        $form = new SimpleForm(function(Player $player, $data) use ($extraData): void{
            ...
            switch($data){
                ...
                case "clan_info":
                    ...
                    break;
                case "leave":
                    ConfirmationForm::onOpen($player, LanguageProvider::getMessageContainer("clan-leave-confirm", $playerName, ["#clanName" => $extraData["clanName"] ?? "???"]), function(Player $player){
                ...
                case "display_info":
                    ...
                    break;
                case "delete":
                    ConfirmationForm::onOpen($player, LanguageProvider::getMessageContainer("clan-delete-confirm", $playerName, ["#clanName" => $extraData["clanName"] ?? "???"]), function(Player $player){
