...
class RankCreateForm extends Form {
    ...
    public static function onOpen(Player $player, array $extraData = []): void{
        ...
        $form->addInput(TextFormat::RED."Nametag of rank", "", $backupRank->getNameTag(), "nametag");
        $form->addInput(TextFormat::RED."Chatprefix of rank", "", $backupRank->getChatPrefix(), "chatperfix");
        $form->addDropdown(TextFormat::RED."Color of rank", ["&1", "&2", "&3", "&4", "&5", "&6", "&7", "&8", "&9", "&f", "&c", "&e", "&g", "&a", "&d"], null, "color");
