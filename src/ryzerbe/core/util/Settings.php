...
class Settings {
    ...
    public function initMySQL(): void{
        ...
        AsyncExecutor::submitMySQLAsyncTask("RyZerCore", function(mysqli $mysqli): void{
            ...
            $mysqli->query("CREATE TABLE IF NOT EXISTS `coinboosts` (`player` VARCHAR(32) KEY NOT NULL, time TEXT NOT NULL, percent INT NOT NULL, for_all BOOL NOT NULL) ENGINE = InnoDB");
            ...
            $mysqli->query("CREATE TABLE IF NOT EXISTS `nicks` (`player` VARCHAR(32) KEY NOT NULL, `nick` VARCHAR(32) NOT NULL DEFAULT 'Player', `nick_skin` TEXT NOT NULL, `nick_level` INT NOT NULL) ENGINE = InnoDB");
