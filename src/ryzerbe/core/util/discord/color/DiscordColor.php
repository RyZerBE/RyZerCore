...
final class DiscordColor {
    ...
    public const GRAY = 9807270;
    public const DARK_GRAY = 8359053;
    public const LIGHT_GRAY = 9936031;
    public const NAVY_BLUE = 3426654;
    ...
    public const LUMINOUS_VIVID_PINK = 16580705;
    public const DARK_VIVID_PINK = 12320855;
}